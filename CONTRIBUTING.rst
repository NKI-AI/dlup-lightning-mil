...
Write Documentation
###################
dlup_lightning_mil could always use more documentation, whether as part of the
official dlup_lightning_mil docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
Get Started!
############
Ready to contribute? Here's how to set up `dlup_lightning_mil` for local development.

1. Fork the `dlup_lightning_mil` repo on GitHub.
2. Clone your fork locally:

.. code-block:: console

    $ git clone git@github.com:your_name_here/dlup_lightning_mil.git
...
3. The pull request should work for Python 3.8 and 3.9, and for PyPy. Check
   https://travis-ci.com/NKI-AI/dlup-lightning-mil/pull_requests
...
.. code-block:: console
    ...
    $ pytest tests.test_dlup_lightning_mil`
...
.. _GitHub repository: https://github.com/NKI-AI/dlup-lightning-mil
